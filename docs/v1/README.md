# galaxy-brain — README (v1 — ARCHIVADO, 2026-07-29)

> **Documento histórico.** Esta es la portada de **v1** (forja/construye), congelada el 2026-07-29.
> Describe un producto que ya no es el que se construye. La portada vigente está en la raíz:
> [README](../../README.md). El porqué del giro: [conclusiones](../../conclusiones-2026-07-29.md).
> Enlaces internos ya reescritos relativos a `docs/v1/`.
...
The four market gaps identified in the [July 2026 deep scan](../deep-scan-2026-07.md) are built and
...
The evidence ([full research report](../research-report.md)) is uncomfortable for harness builders:
...
the inbox, and the merge.** Everything else runs under gates. Full detail in [docs/PLAYBOOK.md](../PLAYBOOK.md).
...
[docs/deep-scan-2026-07.md](../deep-scan-2026-07.md).

## Docs

| Doc | What's in it |
|-----|--------------|
| [docs/PLAYBOOK.md](../PLAYBOOK.md) | How to work with galaxy-brain on any repo: the phase-by-phase pipeline and cadence |
...
| [docs/research-report.md](../research-report.md) | The deep-research evidence base (H1–H11) every rule traces to |
| [docs/ecosystem-ideas.md](../ecosystem-ideas.md) | Ecosystem scan — ideas adopted with attribution, patterns deliberately rejected |
| [docs/deep-scan-2026-07.md](../deep-scan-2026-07.md) | Second-round deep scan — oracles, MCPs, spec kits; what we adopt, watch, reject, and build |
