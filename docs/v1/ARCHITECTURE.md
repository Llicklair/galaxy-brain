# galaxy-brain — Architecture (v1 — FROZEN, 2026-07-29)

> **Esta es la ley de v1 y está congelada.** Se lee, no se edita, y no gobierna lo que se construye
> ahora. La ley vigente está en [ARCHITECTURE.md](../../ARCHITECTURE.md); el porqué del cambio, en
> [conclusiones-2026-07-29.md](../../conclusiones-2026-07-29.md). El código descrito aquí sigue en el repo
> y sigue funcionando: apartado del camino, no borrado.

> Every rule here traces to evidence in [docs/research-report.md](../research-report.md) (H1–H11).
...
Verdicts and evidence for the July 2026 oracle additions: [docs/deep-scan-2026-07.md](../deep-scan-2026-07.md)
and [docs/oracles-report-2026-07.md](../oracles-report-2026-07.md).
...
│   └── memory-global.js     # cross-repo permanent memory: wikilinked vault + SessionStart injection, lean recall (H5, H6)
├── docs/
