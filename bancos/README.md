...
| `experimento_correccion.py` | si el grafo mejora la **corrección** de un agente (A/B, suite oculta) | `claude` CLI · **gasta cuota** | 3/3 y 3/3 a las dos escalas (4 y 215 ficheros) — **sin efecto** |
