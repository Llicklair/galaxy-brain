...
def detect_go_crash(stderr: str) -> dict[str, Any] | None:
    ...
    return {
        "language": "go", "exc_type": "panic", "exc_message": panic_message,
...
def detect_rust_crash(stderr: str) -> dict[str, Any] | None:
    ...
    return {
        "language": "rust", "exc_type": "panic", "exc_message": message,
...
def needs_stderr_capture(cmd_name: str) -> bool:
...
def main() -> int:
    ...
    capture_stderr = needs_stderr_capture(cmd_name)
